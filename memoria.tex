...
\juradoUNO{Christian Yanez Flores (FIUBA)} % \jur1name
\juradoDOS{Lucas Fabricio Monzón Languasco (FIUBA-UNNE)} % \jur2name
\juradoTRES{Daniel Marquez (FIUBA-UC)} % \jur3name
